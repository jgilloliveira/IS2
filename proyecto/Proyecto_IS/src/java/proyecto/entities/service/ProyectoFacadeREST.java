 ...
 */
@Stateless
@Path("proyecto.entities.proyecto")
public class ProyectoFacadeREST extends AbstractFacade<Proyecto> {
    ...
    public String addProyecto(Proyecto proyecto) {
        return super.addProyecto(proyecto);
    }
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String editProyecto(Proyecto entity) {
        return super.editProyecto(entity);
    }
    ...
    public String ultimoProyecto() {
        return super.ultimoProyecto();
    }
    
    @GET
    @Path("/obtener/{id}")
    @Produces(MediaType.APPLICATION_JSON)
    public String obtenerDatoProyecto(@PathParam("id") Integer id) {
        return super.obtenerDatoProyecto(id);
    }
    
    @GET
    @Path("/obtener/nombre/estado/{id}")
    @Produces(MediaType.APPLICATION_JSON)
    public String obtenerNombreEstadoProyecto(@PathParam("id") Integer id) {
        return super.obtenerNombreEstadoProyecto(id);
    }
