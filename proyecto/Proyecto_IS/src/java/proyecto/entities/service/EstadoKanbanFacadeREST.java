 ...
 */
@Stateless
@Path("proyecto.entities.estadokanban")
public class EstadoKanbanFacadeREST extends AbstractFacade<EstadoKanban> {

    @PersistenceContext(unitName = "Proyecto_ISPU")
    private EntityManager em;

    public EstadoKanbanFacadeREST() {
        super(EstadoKanban.class);
    }
