 ...
 */
@Stateless
@Path("proyecto.entities.estadoproyecto")
public class EstadoProyectoFacadeREST extends AbstractFacade<EstadoProyecto> {

    @PersistenceContext(unitName = "Proyecto_ISPU")
    private EntityManager em;

    public EstadoProyectoFacadeREST() {
