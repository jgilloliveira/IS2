...
public class DatoUSActivity extends AppCompatActivity {
    ...
    public void listarEstado(){
        ...
        StringRequest solicitud = new StringRequest(Request.Method.GET, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(bandera.equals("3")){
                    spi_usuario.setVisibility(View.INVISIBLE);
                    btn_eliminar.setVisibility(View.INVISIBLE);
                    id = getIntent().getStringExtra("idUS");
    ...
    public void listarUsuario(){
        String URL = path + "usuario/listar/grupo/"+idGrupo;
        RequestQueue queue = Volley.newRequestQueue(this);
